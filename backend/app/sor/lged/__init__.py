"""LGED Schedule of Rates (SOR) — 4 zones: A (Dhaka/Mymensingh), B (Chattogram/Sylhet), C (Rajshahi/Rangpur), D (Khulna/Barishal)."""
...
if os.path.exists(_rates_path):
    ...
    logger.info(f"Loaded {len(SOR_RATES)} LGED SOR rates")
